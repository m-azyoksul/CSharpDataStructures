...
public class HeapSortHelperTests
{
    /// <summary>
    ...
    public void ComparePredicateList()
    {
        ...
        // Act
        list.HeapSort((x, y) => x.Value.CompareTo(y.Value));
    ...
    public void ComparePredicateList_Random()
    {
        ...
        // Act
        list.HeapSort(comparePredicate);
    ...
    public void ComparerList()
    {
        ...
        // Act
        list.HeapSort(Comparer<Number>.Create((x, y) => x.Value.CompareTo(y.Value)));
